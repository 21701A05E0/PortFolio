                ...
                <section className="first">
                    ...
                    <section className="home" id="h">
                        <div className="content">
                            <h2>Hello, It's Me</h2>
                            <h1>BUKKE RAJKUMAR NAIK</h1>
                            <h2>And I am a <span className="changing">FrontEnd Developer</span></h2>
                            <p style={{forntsize:"30px"}}>I am a computer science student with a deep passion for technology and problem-solving. My journey began with a
                        ...
                        <div className="image" id="newdiv">
                            <img id="newimg" src="image1.jpg" alt="my photo" />
                        </div>
                    </section>
                </section>
                <section className="second" id="a">
                    <div className="image2">
                        <img src="image2.jpg" alt="raju" />
                    </div>
                ...
                <section className="Qua" id="q">
                    ...
                    <div className="qualification">
                        <div>
                            ...
                            <h2 className="clgname">Narayana E.M High school</h2>
                            <h4>tadiparti</h4>
                            <h4>tadiparti</h4>
                        </div>
                        <div>
                            <h1 className="heading">tadiparti</h1>
                            <h2 className="clgname">sai siddhartha junior College</h2>
                            <h4>MPC</h4>
                            <h4>tadiparti</h4>
                        </div>
                        <div>
